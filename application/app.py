...
with st.sidebar:
    ...
    st.markdown(
        ...
        "Agnet를 위해 LangGraph or Strands SDK를 선택하여 활용할 수 있습니다."
        "상세한 코드는 [Github](https://github.com/kyopark2014/mcp-gateway)을 참조하세요."
    )
    ...
    if mode=='Agent' or mode=='Agent (Chat)':
        ...
        mcp_options = [
            "basic", "agentcore gateway", "사용자 설정"
        ]
        mcp_selections = {}
        default_selections = ["basic", "agentcore gateway"]
