...
def load_config():
    ...
    try:
        ...
        config['region'] = client.meta.region_name
        config['projectName'] = "mcp"
        config['accountId'] = client.get_caller_identity()['Account']
...
def get_weather_api_key():
    ...
    try:
        ...
        logger.info(f"Error getting weather API key: {e}")
        pass
